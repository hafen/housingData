#' Housing data
#' 
#' Monthly median home listing and sale price per square foot and number of units sold for 2965 counties in the contiguous United States From late 2008 to January 2014, harvested from Quandl's Zillow Housing Data \url{http://www.quandl.com/housing}.
#' 
