#' Housing data
#'
#' Monthly median home listing, sale price per square foot, and number of units sold for 2984 counties in the contiguous United States From 2008 to January 2016, harvested from Quandl's Zillow Housing Data \url{https://www.quandl.com/collections/housing}.
#'
